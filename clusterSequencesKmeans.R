...
seqs <- readDNAStringSet('Asn_nospaces.txt')
seqs <- readDNAStringSet('Asp_nointrons_nospaces.txt')
seqs <- readDNAStringSet('Cys_nospaces.txt')
seqs <- readDNAStringSet('Gln_nospaces.txt')
seqs <- readDNAStringSet('Gly_nointrons_nospaces.txt')
seqs <- readDNAStringSet('His_nospaces.txt')
seqs <- readDNAStringSet('Ile_nointrons_nospaces.txt')
seqs <- readDNAStringSet('Leu_nointrons_nospaces.txt')
seqs <- readDNAStringSet('Lys_nointrons_nospaces.txt')
seqs <- readDNAStringSet('Met_nointrons_nospaces.txt')
seqs <- readDNAStringSet('Phe_nointron_nospace.txt')
seqs <- readDNAStringSet('Pro_nointrons_nospaces.txt')
seqs <- readDNAStringSet('SeC(e)_nospaces.txt')
seqs <- readDNAStringSet('SeC_nospaces.txt')
seqs <- readDNAStringSet('Ser_nospaces.txt')
seqs <- readDNAStringSet('Sup_nospaces.txt')
seqs <- readDNAStringSet('Thr_nospaces.txt')
seqs <- readDNAStringSet('Trp_nospaces.txt')
seqs <- readDNAStringSet('Tyr_nointrons_nospaces.txt')
seqs <- readDNAStringSet('Ser_nospaces.txt')
seqs <- readDNAStringSet('Undet_nospaces.txt')
seqs <- readDNAStringSet('Val_nointrons_nospaces.txt')

###re-run with split sequences
tRNA <- "Asn"
anticodon <- "ATT"
